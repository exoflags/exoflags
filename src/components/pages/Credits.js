  ...
  <Page>
    ...
    <Container>
      ...
      <Flexbox>
        ...
        <P>
          Original Constellation Icon set by Denis Moskowitz used under creative
          commons licence, available from the noun project here
          <span>Data obtained from the NASA / Caltech exoplanet archive</span>
          Further information and data was obtained from www.exoplanetkyoto.org
          resource
        </P>
      </Flexbox>
    </Container>
